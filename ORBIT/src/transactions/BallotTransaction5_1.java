...
public class BallotTransaction5_1 implements BallotT {
	...
	public BallotTransaction5_1(SourceTransaction[] ringMembers, int source, Additive_Priv_Key signingKey, Additive_Priv_Key newKey, BigInteger passwordGuess, BigInteger passwordDisplacement, ElectionTransaction electionTx, EncryptedVote[] votes, BigInteger passwordRandomization, SecureRandom rand){
		super();
	...
	public boolean minerProcessBallot(ProcessedBlockchain blockchain, AdditiveElgamalPrivKey minerPrivKey, AdditiveElgamalPubKey[] individualMinerKeys, ObjectInputStream[] in, ObjectOutputStream[] out, SecureRandom rand) {
		...
		try {
			...
			if(debug) {
				...
				{
					AdditiveElgamalCiphertext decrypted = ((AdditiveElgamalCiphertext) blindedPasswordOrigDecrypted.homomorphicAdd(blindedPasswordGuessDecrypted.negate(minerKey), minerKey));
